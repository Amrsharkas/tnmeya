/*! jQuery Editable Select - v2.2.4 - https://github.com/indrimuska/jquery-editable-select - (c) 2016 Indri Muska - MIT */ + function(a) {
            ...
            switch (a.keyCode) {
                case 38:
                    var c = b.es.$list.find("li.es-visible:not([disabled])"),
                        d = c.filter("li.selected").prev(),
                        e = c.index(d.length > 0 ? d : c.last());
                    b.highlight(e), a.preventDefault();
                    break;
                case 40:
                    var c = b.es.$list.find("li.es-visible:not([disabled])"),
                        d = c.filter("li.selected").next(),
                        e = c.index(d.length > 0 ? d : c.first());
                    b.highlight(e), a.preventDefault();
                    break;
                case 13:
