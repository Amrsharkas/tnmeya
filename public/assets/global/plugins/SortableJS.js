/* Don't use the minified file from github as sorting target will be buggy */
/**!
 * Sortable
    ...
    function Sortable(el, options) {
        ...
        var defaults = {
            ...
            supportPointer: Sortable.supportPointer !== false && (
                ('PointerEvent' in window) || window.navigator && ('msPointerEnabled' in window.navigator) // microsoft
            ),
