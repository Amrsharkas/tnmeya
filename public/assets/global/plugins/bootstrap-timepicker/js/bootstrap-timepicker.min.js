    ...
    s.prototype = {
        ...
        _init: function() {
            ...
            this.showWidgetOnAddonClick && (this.$element.parent().hasClass("input-append") || this.$element.parent().hasClass("input-prepend")) ? (this.$element.parent(".input-append, .input-prepend").find(".add-on").on({
                ...
                "blur.timepicker": t.proxy(this.blurElement, this),
                "mousewheel.timepicker DOMMouseScroll.timepicker": t.proxy(this.mousewheel, this)
            }), this.$widget = this.template !== !1 ? t(this.getTemplate()).on("click", t.proxy(this.widgetClick, this)) : !1, this.showInputs && this.$widget !== !1 && this.$widget.find("input").each(function() {
                t(this).on({
        ...
        place: function() {
            if (!this.isInline) {
                var e = this.$widget.outerWidth(),
                    ...
                    u = d.left,
                    p = d.top;
                this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"), "auto" !== this.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (u -= e - l)) : (this.$widget.addClass("timepicker-orient-left"), d.left < 0 ? u -= d.left - n : d.left + e > h && (u = h - e - n));
        ...
        setDefaultTime: function(t) {
            if (this.$element.val()) this.updateFromElementVal();
                ...
                var i = new Date,
                    ...
                    n = i.getSeconds(),
                    h = "AM";
                0 !== n && (n = Math.ceil(i.getSeconds() / this.secondStep) * this.secondStep, 60 === n && (s += 1, n = 0)), 0 !== s && (s = Math.ceil(i.getMinutes() / this.minuteStep) * this.minuteStep, 60 === s && (e += 1, s = 0)), this.showMeridian && (0 === e ? e = 12 : e >= 12 ? (e > 12 && (e -= 12), h = "PM") : h = "AM"), this.hour = e, this.minute = s, this.second = n, this.meridian = h, this.update()
        ...
        return e.shift(), this.each(function() {
            var n = t(this),
                h = n.data("timepicker"),
                o = "object" == typeof i && i;
            h || n.data("timepicker", h = new s(this, t.extend({}, t.fn.timepicker.defaults, o, t(this).data()))), "string" == typeof i && h[i].apply(h, e)
        })
