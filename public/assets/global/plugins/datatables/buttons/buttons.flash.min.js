(function(g) {
    ...
    function w(a) {
        q === p && (q = -1 === u.serializeToString(g.parseXML(o["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
    ...
    i.Client.prototype = {
        ...
        getHTML: function(a, b) {
            ...
            if (navigator.userAgent.match(/MSIE/)) var e = location.href.match(/^https/i) ? "https://" : "http://",
                d = d + ('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + e + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="' + a + '" height="' + b + '" id="' + this.movieId + '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="' + i.moviePath + '" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="' + c + '"/><param name="wmode" value="transparent"/></object>');
    ...
    var x = function(a, b) {
        ...
        z = function(a, b) {
            for (var d = y(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), i = b.escapeChar !== p ? b.escapeChar : "\\", j = function(a) {
                    for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(g, i + e) + e : a[c];
                    return b
                }, l = b.header ? j(c.header) + d : "", D = b.footer && c.footer ? d + j(c.footer) : "", m = [], n = 0, h = c.body.length; n < h; n++) m.push(j(c.body[n]));
            return {
                str: l + m.join(d) + D,
                rows: m.length
            }
    ...
    h.ext.buttons.excelFlash = g.extend({}, t, {
        ...
        action: function(a, b, d, c) {
                ...
                j, l, h = function(a) {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        ...
                        if (!(null === a[b] || a[b] === p || "" === a[b])) {
                            ...
                            h || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? h = n(f, "c", {
                                attr: {
                                    t: "n",
                                    r: d
                                },
                            ...
                            }) : (o = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), h = n(f, "c", {
                                attr: {
                                    t: "inlineStr",
                                    r: d
                                },
            ...
            m = 0;
            for (r = k.header.length; m < r; m++) h.appendChild(n(f, "col", {
                attr: {
                    min: m + 1,
                    max: m + 1,
                    width: B(k, m),
