...
scheduler.templates.agenda_time = function(start, end, ev) {
    ...
    else return scheduler.templates.day_date(start) + " &ndash; " + scheduler.templates.day_date(end);
};
...
scheduler.attachEvent("onTemplatesReady", function() {
    ...
    scheduler.render_data = function(evs) {
        if (this._mode == "agenda") fill_agenda_tab();
    ...
    function set_full_view(mode) {
        if (mode) {
            ...
            scheduler._els["dhx_cal_header"][0].innerHTML = "<div " + rowAttr + " class='dhx_agenda_line'>" + "<div " + dateHeader + ">" + l.date + "</div>" + "<span style='padding-left:25px' " + descriptionHeader + ">" + l.description + "</span>" + "</div>";
