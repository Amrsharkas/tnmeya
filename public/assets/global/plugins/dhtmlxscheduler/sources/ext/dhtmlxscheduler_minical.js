...
scheduler._render_calendar = function(obj, sd, conf, previous) {
    ...
    d.innerHTML = "<div class='dhx_year_month'></div>" + "<div class='dhx_year_grid'>" + "<div class='dhx_year_week'>" + (week_template ? week_template.innerHTML : "") + "</div>" + "<div class='dhx_year_body'></div>" + "</div>";
