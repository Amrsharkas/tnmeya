    ...
    function setupKeyNav(scheduler) {
        ...
        scheduler.$keyboardNavigation.dispatcher = {
            ...
            keyDownHandler: function(e) {
                ...
                if (scheduler.$keyboardNavigation.isModal() && !(activeElement && activeElement.container && scheduler._locate_css({
        ...
        (function() {
            ...
            scheduler.attachEvent("onDataRender", function() {
                ...
                if (dispatcher.isEnabled() && !scheduler.getState().editor_id) {
                    ...
                    if (activeNode instanceof scheduler.$keyboardNavigation.MinicalButton || activeNode instanceof scheduler.$keyboardNavigation.MinicalCell) return;
            ...
            function isMinical(focusElement) {
                for (var i = 0; i < minicalendars.length; i++) {
                    if (isChildOf(focusElement, minicalendars[i])) return true;
                }
                return false;
            }
