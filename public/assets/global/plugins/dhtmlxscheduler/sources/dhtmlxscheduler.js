...
! function() {
    ...
    window.dhtmlx || (dhtmlx = function(t) {
        ...
        navigator.userAgent.toLowerCase().indexOf("chrome") > -1 && (_isChrome = !0), -1 != navigator.userAgent.indexOf("Safari") || -1 != navigator.userAgent.indexOf("Konqueror") ? (_KHTMLrv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)), _KHTMLrv > 525 ? (_isFF = !0, _FFrv = 1.9) : _isKHTML = !0) : -1 != navigator.userAgent.indexOf("Opera") ? (_isOpera = !0, _OperaRv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3))) : -1 != navigator.appName.indexOf("Microsoft") ? (_isIE = !0, -1 == navigator.appVersion.indexOf("MSIE 8.0") && -1 == navigator.appVersion.indexOf("MSIE 9.0") && -1 == navigator.appVersion.indexOf("MSIE 10.0") || "BackCompat" == document.compatMode || (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])), dtmlXMLLoaderObject.prototype.doXPath = function(t, e, i, a) {
            ...
            var n = e;
            e || (e = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML), e || dhtmlxError.throwError("LoadXML", "Incorrect XML", [e || this.xmlDoc, this.mainObject]), -1 != e.nodeName.indexOf("document") ? n = e : (n = e, e = e.ownerDocument);
    ...
    dataProcessor.prototype = {
        setTransactionMode: function(t, e) {
            "object" == typeof t ? (this._tMode = t.mode || this._tMode, void 0 !== t.headers && (this._headers = t.headers), void 0 !== t.payload && (this._payload = t.payload)) : (this._tMode = t, this._tSend = e), "REST" == this._tMode && (this._tSend = !1, this._endnm = !0), "JSON" == this._tMode && (this._tSend = !1, this._endnm = !0, this._headers = this._headers || {}, this._headers["Content-type"] = "application/json")
        },
        escape: function(t) {
    ...
    Scheduler.plugin = function(t) {
        ...
        dhtmlxEventable(t),
            ...
            t.xy = {
                ...
                t._is_material_skin() ? (r || (r = document.createElement("div"), r.className = "dhx_cal_scale_placeholder", this.$container.insertBefore(r, this._els.dhx_cal_header[0])), r.style.display = "block", this.set_xy(r, e, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1))) : r && r.parentNode.removeChild(r), this.set_xy(this._els.dhx_cal_navline[0], e, this.xy.nav_height, 0, 0), this.set_xy(this._els.dhx_cal_header[0], e - a, this.xy.scale_height, n, this.xy.nav_height + (this._quirks ? -1 : 1));
                ...
                if (this._drag_mode) {
                    ...
                    if (this._is_pos_changed(this._drag_pos, i)) {
                        ...
                        if (t.matrix && (d = t.matrix[t._mode]), d = d || {
                                x_step: 1,
                                x_unit: "day"
                            }, "move" == this._drag_mode) a = this._min_date.valueOf() + 6e4 * (i.y * this.config.time_step + 24 * i.x * 60), !i.custom && this._table_view && (a += 1e3 * this.date.time_part(_.start_date)), !this._table_view && this._dragEventBody && void 0 === this._drag_event._move_event_shift && (this._drag_event._move_event_shift = a - _.start_date), this._drag_event._move_event_shift && (a -= this._drag_event._move_event_shift), a = this._correct_shift(a), i._ignores && this.config.preserve_length && this._table_view ? (a = t._correct_drag_start_date(a), n = t._correct_drag_end_date(a, this._drag_event._event_length)) : n = _.end_date.valueOf() - (_.start_date.valueOf() - a);
                        else {
                        ...
                        if ("move" == this._drag_mode && t.config.limit_drag_out && (+v < +t._min_date || +n > +t._max_date)) {
                            if (+_.start_date < +t._min_date || +_.end_date > +t._max_date) v = new Date(_.start_date), n = new Date(_.end_date);
                                ...
                                var m = n - v; + v < +t._min_date ? (v = new Date(t._min_date), i._ignores && this.config.preserve_length && this._table_view ? (v = new Date(t._correct_drag_start_date(v)), d._start_correction && (v = new Date(v.valueOf() + d._start_correction)), n = new Date(1 * v + this._get_fictional_event_length(v, this._drag_event._event_length, d))) : n = new Date(+v + m)) : (n = new Date(t._max_date), i._ignores && this.config.preserve_length && this._table_view ? (d._end_correction && (n = new Date(n.valueOf() - d._end_correction)), n = new Date(1 * n - this._get_fictional_event_length(n, 0, d, !0)), v = new Date(1 * n - this._get_fictional_event_length(n, this._drag_event._event_length, d, !0)), this._ignores_detected && (v = t.date.add(v, d.x_step, d.x_unit), n = new Date(1 * n - this._get_fictional_event_length(n, 0, d, !0)), n = t.date.add(n, d.x_step, d.x_unit))) : v = new Date(+n - m))
                            }
                            var f = new Date(n - 1)
                        }
                        ...
                        if (n && (this._drag_event._dhx_changed || !this._drag_event.start_date || r.start_date.valueOf() != this._drag_event.start_date.valueOf() || r.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                            ...
                            if (this.callEvent("onBeforeEventChanged", [r, e, s, this._drag_event]))
                                if (this._drag_id = this._drag_mode = null, s && this.config.edit_on_create) {
                                    if (this.unselect(), this._new_event = new Date, this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(i))) return t.callEvent("onDragEnd", [i, a, e]), this.showLightbox(i);
        ...
        t.date = {
            ...
            function() {
                ...
                var e = t.end_date.getDate() - t.start_date.getDate();
                return e ? (e < 0 && (e = Math.ceil((t.end_date.valueOf() - t.start_date.valueOf()) / 864e5)), 1 == e && !t.end_date.getHours() && !t.end_date.getMinutes() && (t.start_date.getHours() || t.start_date.getMinutes())) : t.start_date.getMonth() == t.end_date.getMonth() && t.start_date.getFullYear() == t.end_date.getFullYear()
                ...
                if (e = this._table_view ? this._pre_render_events_table(e, i) : this._pre_render_events_line(e, i), this._table_view)
                    if (i) this._colsS.heights = n;
                        ...
                        if (o.rows) {
                            ...
                            if (r.unshift(0), o.parentNode.offsetHeight < o.parentNode.scrollHeight && !t._colsS.scroll_fix && t.xy.scroll_width) {
                                var u = t._colsS,
                                    g = u[u.col_length],
                                    f = u.heights.slice();
                ...
                for (var n = 0; n < t.length; n++) {
                    ...
                    if (r._sday = this._get_event_sday(r), this._ignores[r._sday]) t.splice(n, 1), n--;
                        ...
                        }(d < this.config.first_hour || _ >= this.config.last_hour) && (a.push(r), t[n] = r = this._copy_event(r), d < this.config.first_hour && (r.start_date.setHours(this.config.first_hour), r.start_date.setMinutes(0)), _ >= this.config.last_hour && (r.end_date.setMinutes(0), r.end_date.setHours(this.config.last_hour)), r.start_date > r.end_date || d == this.config.last_hour) && (t.splice(n, 1), n--)
                    }
                }
                if (!e) {
                    ...
                    if (s) {
                        ...
                        if (this._waiAria.eventAttr(e, m), this._rendered.push(m), i.appendChild(m), u = u + parseInt(s.style.left, 10) + r, this._edit_id == e.id) {
                            ...
                            this.set_xy(x, c - 6, _ - 26), x.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", m.appendChild(x), this._els.dhx_cal_data[0].appendChild(m), this._rendered.push(m), x.innerHTML = "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>",
                                this._quirks7 && (x.firstChild.style.height = _ - 12 + "px"), this._editor = x.firstChild, this._editor.onkeydown = function(e) {
                                ...
                                }, t._focus(x.firstChild, !0), this._els.dhx_cal_data[0].scrollLeft = 0
                        }
            ...
            t._get_event_bar_pos = function(e) {
                ...
                if (i = i || t._mode, a && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [a, i]))) {
                    ...
                    var s = a.color,
                        o = a.textColor;
                    if (t.config.highlight_displayed_event && (a.color = t.config.displayed_event_color, a.textColor = t.config.displayed_event_text_color), t.setCurrentView(new Date(a.start_date), i), a.color = s, a.textColor = o, t.config.scroll_hour = n, t.config.preserve_scroll = r, t.matrix && t.matrix[i]) {
                        var d = t.getRenderedEvent(a.id);
                        d && (t._els.dhx_cal_data[0].scrollTop = t.$domHelpers.getAbsoluteTop(d) - t.$domHelpers.getAbsoluteTop(t._els.dhx_cal_data[0]) - 20)
                    }
                ...
                if (e = e || this._load_url) {
                    ...
                    if (i = i || this._date, this._load_mode) {
                        ...
                        if (n <= i) return !1;
                        for (t.$ajax.get(e + "&from=" + r(i) + "&to=" + r(n), a); i < n;) this._loaded[r(i)] = !0,
            ...
            t._xmlNodeToJSON = function(t) {
                ...
                time: {
                    ...
                    set_value: function(e, i, a, n) {
                        ...
                        if (d.full_day) {
                            ...
                            c.checked = 0 === t.date.time_part(a.start_date) && 0 === t.date.time_part(a.end_date), _[l[0]].disabled = c.checked, _[l[0] + _.length / 2].disabled = c.checked, c.onclick = function() {
                                ...
                                _[l[0]].disabled = c.checked, _[l[0] + _.length / 2].disabled = c.checked, r(_, 0, s || a.start_date), r(_, 4, o || a.end_date)
                            }
                        }
                    ...
                    get_value: function(e, i, a) {
                        ...
                        if (i.start_date = new Date(n[r[3]].value, n[r[2]].value, n[r[1]].value, 0, n[r[0]].value), i.end_date = new Date(n[r[3] + 4].value, n[r[2] + 4].value, n[r[1] + 4].value, 0, n[r[0] + 4].value), !n[r[3]].value || !n[r[3] + 4].value) {
            ...
            t._init_lightbox_events = function() {
                ...
                t._lb_start && (t._lb_start = t._dnd_start_lb = !1, document.body.className = document.body.className.replace(" dhx_unselectable", ""), document.dhx_unselectable = !1)
                ...
                n(document.body, e[0], function(e) {
                    ...
                    n(this._els.dhx_cal_data[0], "contextmenu", function(t) {
                        ...
                        if (!a(e)) {
                            ...
                            if (g = r, !c && !h && t.config.touch_drag) {
            ...
            t._show_global_tip = function() {
                ...
                e._methods = ["_set_event_text_style", "", "_dp_change_event_id", "_dp_hook_delete"], this._dp_change_event_id = function(e, i) {
                    ...
                    this._dp_hook_delete = function(i, a) {
                        ...
                        if (this._validId(t)) {
                            var i = e.getState(t);
                            return "inserted" == i || this._new_event ? (e.setUpdated(t, !1), !0) : "deleted" != i && ("true_deleted" == i || (e.setUpdated(t, !0, "deleted"), !1))
                        }
                ...
                if (this._configure(t.config, t._skin_settings, n), this._configure(t.xy, t._skin_xy, n), "flat" === t.skin && (t.xy.scale_height = 35, t.templates.hour_scale = function(t) {
                    ...
                    d && (d.padding = 14), t.templates.event_bar_date = function(e, i, a) {
                        ...
                        if (t.templates.month_day = function(a) {
                                if ("month" == this._mode) {
                                    var n = e(a);
                                    return 1 == a.getDate() && (n = t.locale.date.month_full[a.getMonth()] + " " + n), +a == +t.date.date_part(this._currentDate()) && (n = t.locale.labels.dhx_cal_today_button + " " + n), n
                                }
                        ...
                        return this.each(function() {
                            if (this && this.getAttribute)
                                if (this.getAttribute("dhxscheduler")) n.push(window[this.getAttribute("dhxscheduler")]);
                                    ...
                                    this.getElementsByTagName("div").length || (this.innerHTML = '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>', this.className += " dhx_cal_container"), i.init(this, i.config.date, i.config.mode), a.data && i.parse(a.data), n.push(i), e++
                                }
                        }), 1 === n.length ? n[0] : n
                    }
