...
scheduler.form_blocks.combo = {
    ...
    set_value: function(e, t, a, r) {
        ...
        if (i.enableFilteringMode(r.filtering, r.script_path || null, !!r.cache), r.script_path) {
            var s = a[r.map_to];
            s ? r.cached_options[s] ? (i.addOption(s, r.cached_options[s]), i.disable(1), i.selectOption(0), i.disable(0)) : dhtmlxAjax.get(r.script_path + "?id=" + s + "&uid=" + scheduler.uid(), function(e) {
                var t = e.doXPath("//option")[0],
                    a = t.childNodes[0].nodeValue;
                r.cached_options[s] = a, i.addOption(s, a),
                    i.disable(1), i.selectOption(0), i.disable(0)
            }) : i.setComboValue("")
        } else {
    ...
    get_value: function(e, t, a) {
        ...
        return r || (r = e.nextSibling.getElementsByTagName("input")[0]), r.checked ? a.checked_value || !0 : a.unchecked_value || !1
    },
    focus: function(e) {}
};
