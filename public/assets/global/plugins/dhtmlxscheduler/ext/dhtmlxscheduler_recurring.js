...
scheduler.config.occurrence_timestamp_in_utc = !1, scheduler.config.recurring_workdays = [1, 2, 3, 4, 5], scheduler.form_blocks.recurring = {
        ...
        _init_set_value: function(e, t, a) {
            ...
            function n() {
                m("dhx_repeat_day").style.display = "none",
                    m("dhx_repeat_week").style.display = "none", m("dhx_repeat_month").style.display = "none", m("dhx_repeat_year").style.display = "none", m("dhx_repeat_" + this.value).style.display = "block", scheduler.setLightboxSize()
            }

            function i(e) {
                var t = [c(g, "repeat")];
                for (y[t[0]](t, e); t.length < 5;) t.push("");
                var a = "",
                    r = s(g);
                if ("no" == r) e.end = new Date(9999, 1, 1), a = "no";
                else if ("date_of_end" == r) e.end = u(c(g, "date_of_end"));
                else {
                    scheduler.transpose_type(t.join("_")), a = Math.max(1, c(g, "occurences_count"));
                    var n = 0;
            ...
            function l(e, t) {
                ...
                switch (e = r[0].split("_"), b[e[0]](e, t), r[1]) {
                    ...
                    case "":
                        d(g, "date_of_end");
                        var n = t.end;
                        scheduler.config.include_end_by && (n = scheduler.date.add(n, -1, "day")), a(g, "date_of_end", v(n));
                        break;
                    default:
                        d(g, "occurences_count"), a(g, "occurences_count", r[1])
                }
                a(g, "repeat", e[0]);
            ...
            var y = {
                    month: function(e, t) {
                        ...
                        "d" == a(g, "month_type") ? (e.push(Math.max(1, r(g, "month_count"))), t.start.setDate(a(g, "month_day"))) : (e.push(Math.max(1, r(g, "month_count2"))), e.push(a(g, "month_day2")), e.push(Math.max(1, r(g, "month_week2"))), scheduler.config.repeat_precise || t.start.setDate(1)), t._start = !0
                    },
                    week: function(e, t) {
                        var a = scheduler.form_blocks.recurring._get_node_value,
                            r = scheduler.form_blocks.recurring._get_node_numeric_value;
                        e.push(Math.max(1, r(g, "week_count"))), e.push(""), e.push("");
                        for (var n = [], i = a(g, "week_day", !0), s = t.start.getDay(), d = !1, l = 0; l < i.length; l++) n.push(i[l]), d = d || i[l] == s;
                        n.length || (n.push(s), d = !0), n.sort(), scheduler.config.repeat_precise ? d || (scheduler.transpose_day_week(t.start, n, 1, 7), t._start = !0) : (t.start = scheduler.date.week_start(t.start), t._start = !0), e.push(n.join(","))
                    },
                    day: function(e) {
                        var t = scheduler.form_blocks.recurring._get_node_value,
                            a = scheduler.form_blocks.recurring._get_node_numeric_value;
                        "d" == t(g, "day_type") ? e.push(Math.max(1, a(g, "day_count"))) : (e.push("week"), e.push(1), e.push(""), e.push(""), e.push(scheduler.config.recurring_workdays.join(",")), e.splice(0, 1))
                    },
                    year: function(e, t) {
                        var a = scheduler.form_blocks.recurring._get_node_value;
                        "d" == a(g, "year_type") ? (e.push("1"), t.start.setMonth(0), t.start.setDate(a(g, "year_day")), t.start.setMonth(a(g, "year_month"))) : (e.push("1"), e.push(a(g, "year_day2")), e.push(a(g, "year_week2")), t.start.setDate(1), t.start.setMonth(a(g, "year_month2"))), t._start = !0
                    }
                },
                b = {
                    week: function(e, t) {
                    ...
                    month: function(e, t) {
                        var a = scheduler.form_blocks.recurring._set_node_value;
                        "" === e[2] ? (a(g, "month_type", "d"), a(g, "month_count", e[1]), a(g, "month_day", t.start.getDate())) : (a(g, "month_type", "w"), a(g, "month_count2", e[1]), a(g, "month_week2", e[3]), a(g, "month_day2", e[2]))
                    },
                    day: function(e, t) {
                        var a = scheduler.form_blocks.recurring._set_node_value;
                        a(g, "day_type", "d"), a(g, "day_count", e[1])
                    },
                    year: function(e, t) {
                        var a = scheduler.form_blocks.recurring._set_node_value;
                        "" === e[2] ? (a(g, "year_type", "d"), a(g, "year_day", t.start.getDate()), a(g, "year_month", t.start.getMonth())) : (a(g, "year_type", "w"), a(g, "year_week2", e[3]), a(g, "year_day2", e[2]), a(g, "year_month2", t.start.getMonth()))
                    }
                };
            ...
            for (var x = 0; x < f.elements.length; x++) {
                ...
                switch (w.name) {
                    case "repeat":
                        "SELECT" == w.nodeName ? w.onchange = n : w.onclick = n
                }
            }
        ...
        set_value: function(e, t, a) {
            ...
            var n = r._ds;
            n.start = a.start_date, n.end = a._end_date,
        ...
        _toggle_block: function() {
            var e = scheduler.form_blocks.recurring,
                t = e._get_form(),
                a = e._get_button();
            t.open || t.blocked ? (t.style.height = "0px", a && (a.style.backgroundPosition = "-5px 20px", a.nextSibling.innerHTML = scheduler.locale.labels.button_recurring)) : (t.style.height = "auto", a && (a.style.backgroundPosition = "-5px 0px", a.nextSibling.innerHTML = scheduler.locale.labels.button_recurring_open)), t.open = !t.open, scheduler.setLightboxSize()
        },
        focus: function(e) {},
    ...
    function() {
        ...
        scheduler.addEvent = function(t, a, r, n, i) {
            ...
            if (s) {
                var d = scheduler.getEvent(s);
                this._is_modified_occurence(d) && scheduler._add_rec_marker(d, 1e3 * d.event_length),
        ...
        if (!this._ignore_call) {
            this._ignore_call = !0, scheduler._rec_markers[e] && (scheduler._rec_markers[t] = scheduler._rec_markers[e], delete scheduler._rec_markers[e]), scheduler._rec_markers_pull[e] && (scheduler._rec_markers_pull[t] = scheduler._rec_markers_pull[e], delete scheduler._rec_markers_pull[e]);
            ...
            for (var a in this._rec_markers) {
                var r = this._rec_markers[a];
                r.event_pid == e && (r.event_pid = t, r._pid_changed = !0)
            }
            var n = scheduler._rec_markers[t];
            n && n._pid_changed && (delete n._pid_changed, setTimeout(function() {
                scheduler.callEvent("onEventChanged", [t, scheduler.getEvent(t)])
        ...
        if (this._is_virtual_event(e)) {
            ...
            for (var s in i) i.hasOwnProperty(s) && (delete this._rec_markers[i[s].id], this.deleteEvent(i[s].id, !0));
        ...
        if ((n || 1 * n === 0) && r.rec_type) return s(e);
    ...
    function() {
        ...
        for (var i = (e.getDay() || (scheduler.config.start_on_monday ? 7 : 0)) - a, s = 0; s < t.length; s++)
            if (t[s] > i) return e.setDate(e.getDate() + 1 * t[s] - i - (r ? a : n));
        ...
        if (!this.date[t]) {
            ...
            if ("day" == a[0] || "week" == a[0]) {
                var s = null;
                if (a[4] && (s = a[4].split(","), scheduler.config.start_on_monday)) {
                    for (var d = 0; d < s.length; d++) s[d] = 1 * s[d] || 7;
                    s.sort()
                }
                this.date[t] = function(e, t) {
                    var a = Math.floor((t.valueOf() - e.valueOf()) / (r * i));
                    a > 0 && e.setDate(e.getDate() + a * i), s && scheduler.transpose_day_week(e, s, 1, i)
                }, this.date[n] = function(e, t) {
                    var a = new Date(e.valueOf());
                    if (s)
                        for (var r = 0; t > r; r++) scheduler.transpose_day_week(a, s, 0, i);
        ...
        var s = i || -1,
            d = new Date(e.start_date.valueOf()),
            l = 0;
        ...
        for (; n > d && d < e.end_date && (0 > s || s > l);) {
            var o = scheduler.config.occurrence_timestamp_in_utc ? Date.UTC(d.getFullYear(), d.getMonth(), d.getDate(), d.getHours(), d.getMinutes(), d.getSeconds()) : d.valueOf(),
                c = this._get_rec_marker(o, e.id);
            if (c) a && ("none" != c.rec_type && l++, t.push(c));
            else {
                var _ = new Date(d.valueOf() + 1e3 * e.event_length),
                    h = this._copy_event(e);
                if (h.text = e.text, h.start_date = d, h.event_pid = e.id, h.id = e.id + "#" + Math.ceil(o / 1e3), h.end_date = _, h.end_date = scheduler._fix_daylight_saving_date(h.start_date, h.end_date, e, d, h.end_date), h._timed = this.isOneDayEvent(h), !h._timed && !this._table_view && !this.config.multi_day) return;
                t.push(h), a || (this._events[h.id] = h, this._rec_temp.push(h)), l++
            }
        ...
        return i ? i > 0 ? new Date(r.valueOf() + 1e3 * a.event_length - 60 * i * 1e3) : new Date(t.valueOf() - 60 * i * 1e3) : new Date(n.valueOf())
    }, scheduler.getRecDates = function(e, t) {
        var a = "object" == typeof e ? e : scheduler.getEvent(e),
            r = [];
        if (t = t || 100, !a.rec_type) return [{
            start_date: a.start_date,
            end_date: a.end_date
        }];
        if ("none" == a.rec_type) return [];
        scheduler.repeat_date(a, r, !0, a.start_date, a.end_date, t);
        for (var n = [], i = 0; i < r.length; i++) "none" != r[i].rec_type && n.push({
            start_date: r[i].start_date,
            end_date: r[i].end_date
        });
        return n
        ...
        for (var r in this._events) {
            ...
            if (n && n.start_date < t && n.end_date > e)
                if (n.rec_pattern) {
                    ...
                    for (var s = 0; s < i.length; s++) !i[s].rec_pattern && i[s].start_date < t && i[s].end_date > e && !this._rec_markers[i[s].id] && a.push(i[s])
