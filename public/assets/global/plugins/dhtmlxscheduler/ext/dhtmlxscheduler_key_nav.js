    ...
    function e(e) {
        ...
        e.config.key_nav = !0, e.config.key_nav_step = 30, e.addShortcut = function(e, a, i) {
            ...
            e.$keyboardNavigation.Event = function(t) {
                ...
                t || (s ? (t = e.date[s.name + "_start"](new Date(n.date)), t = this.findVisibleColumn(t)) : (t = new Date(e.getState().min_date), t = this.findVisibleColumn(t), t.setHours(e.config.first_hour))), a || (a = s ? e.date.add(t, s.x_step, s.x_unit) : e.date.add(t, e.config.key_nav_step, "minute")), this.section = i || this._getDefaultSection(), this.start_date = new Date(t), this.end_date = new Date(a), this.movingDate = r || null
            ...
            function() {
                ...
                if (e.attachEvent("onLightbox", o), e.attachEvent("onAfterLightbox", n), e.attachEvent("onAfterQuickInfo", function() {
                    ...
                    dhtmlx.attachEvent("onMessagePopup", function(t) {
                        ...
                        t && e.eventRemove(t, "keydown", d), setTimeout(function() {
                            ...
                            t || (c && c.parentNode ? c.focus() : h && h.parentNode && h.focus(), c = null, h = null)
                        }, 1)
                    })
                }
                ...
                document.body ? dhtmlxEvent(document.body, "mousemove", t) : dhtmlxEvent(window, "load", function() {
                    ...
                    var s = r();
                    if ((t.ctrlKey || t.metaKey) && 67 == t.keyCode) return s && (e._buffer_id = s, n = !0, e.callEvent("onEventCopied", [e.getEvent(s)])), !0;
