...
scheduler.attachEvent("onTemplatesReady", function() {
    ...
    scheduler.addEventNow = function(e, t, a) {
        ...
        _ && (c = c + " " + _);
        var u = '<div event_id="' + l + '" class="' + c + '" style="position:absolute; top:' + a + "px; left:" + t + "px; width:" + (i - 4) + "px; height:" + r + "px;" + (n || "") + '">';
        return u += '<div class="dhx_header" style=" width:' + (i - 6) + 'px;" >&nbsp;</div>', u += '<div class="dhx_title">' + s + "</div>", u += '<div class="dhx_body" style=" width:' + (i - (this._quirks ? 4 : 14)) + "px; height:" + (r - (this._quirks ? 20 : 30)) + 'px;">' + d + "</div>", u += '<div class="dhx_footer" style=" width:' + (i - 8) + "px;" + (o ? " margin-top:-1px;" : "") + '" ></div></div>',
            h.innerHTML = u, h.style.zIndex = 100, h.firstChild
        ...
        if (scheduler.getLayer(e.layer).noMenu && (t = 0), !(e._sday < 0)) {
            ...
            if (a) {
                ...
                if (this._select_id == e.id) {
                    ...
                    var f = this._render_v_bar(e.id, o - t + 1, n, t, 20 * _.length + 26, "", "<div class='dhx_menu_head'></div>", u, !0);
                    f.style.left = o - t + 1, f.style.zIndex = l.style.zIndex, this._els.dhx_cal_data[0].appendChild(f), this._rendered.push(f)
                }
            }
        }
