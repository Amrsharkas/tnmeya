...
dhtmlXTreeObject.prototype.enableItemEditor = function(mode) {
    ...
    if (!this._eItEdFlag) {
        ...
        this.setOnClickHandler(function(a, b) {
            ...
            if ((this.ed_hist_clcik == a) && (this._edn_click_IE)) this._editItem(a, b);
...
dhtmlXTreeObject.prototype._stopEdit = function(a, mode) {
    if (this._editCell) {
        ...
        if (this._editCell.id != a) {
            ...
            if (editText === true) editText = this._editCell.span.childNodes[0].value;
            ...
            this._editCell = null;
            if (!mode) this.callEvent("onEdit", [3, id, this, changed]);
            if (this._enblkbrd) {
...
dhtmlXTreeObject.prototype.stopEdit = function(mode) {
    if (this._editCell) this._stopEdit(this._editCell.id + "_non", mode);
}
/**
...
dhtmlXTreeObject.prototype._editItem = function(id, tree) {
    if (this._eItEd) {
        ...
        if (editText === true) editText = (typeof temp.span.innerText != "undefined" ? temp.span.innerText : temp.span.textContent);
