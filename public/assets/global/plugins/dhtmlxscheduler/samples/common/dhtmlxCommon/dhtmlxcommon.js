...
if (typeof(window.dhx) == "undefined") {
    window.dhx = window.dhx4 = {
        ...
        readFromCss: function(className, property, innerHTML) {
            ...
            if (document.body.firstChild != null) document.body.insertBefore(t, document.body.firstChild);
        ...
        _copyObj: function(r) {
            if (this._isObj(r)) {
                var t = {};
                for (var a in r) {
                    if (typeof(r[a]) == "object" && r[a] != null) t[a] = this._copyObj(r[a]);
                    else t[a] = r[a];
                }
            } else {
                var t = [];
        ...
        selectTextRange: function(inp, start, end) {
            ...
            if (inp.setSelectionRange) {
                ...
                } catch (e) {}; // combo in grid under IE requires try/catch
        ...
        */
        ...
        var getInd = function(val, ar) {
            for (var q = 0; q < ar.length; q++)
                if (ar[q].toLowerCase() == val) return q;
            return -1;
        }
        ...
        xmltop: function(tagname, xhr, obj) {
            if (typeof xhr.status == "undefined" || xhr.status < 400) {
                ...
                if (xml && xml.documentElement !== null) {
                    try {
                        if (!xml.getElementsByTagName("parsererror").length) return xml.getElementsByTagName(tagname)[0];
                    } catch (e) {}
                }
            }
...
if (typeof(window.dhtmlx) == "undefined") {
    window.dhtmlx = {
        ...
        extend_api: function(name, map, ext) {
            ...
            if (ext) dhtmlx.extend(window[name].prototype, ext);
        },
        url: function(str) {
