...
function dhtmlXCellObject(idd, css) {
    ...
    this.conf = {
        ...
        ofs_nodes: {
            t: {},
            b: {}
        } // attached dataNodes (menu/toolbar/status), can be true, false;
...
dhtmlXCellObject.prototype._detachURLEvents = function(fr) {
    ...
    if (typeof(window.addEventListener) == "function") {
        ...
        try {
            ...
            /* console.log("error: url detach mousedown event fail"); */ };
    } else {
...
function dhtmlXCellTop(base, offsets) {
    ...
    this.conf.ofs = {
        ...
        l: 0,
        r: 0
    }; // base outer offset (fullscreen margins)
    this.conf.ofs_nodes = {
        t: {},
        b: {}
    }; // attached menu/toolbar/sb/hdr/ftr
    this.conf.progress = false;
