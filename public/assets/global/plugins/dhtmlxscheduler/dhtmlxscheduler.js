...
window.dhtmlXScheduler = window.scheduler = {
    ...
    function() {
        ...
        markRow: function(e, t, i) {
            var a = "",
                r = this.is_invalid(e);
            if (r && (a = this.styles[r], t = !0), this.callEvent("onRowMark", [e, t, i, r]) && (a = this.styles[t ? i : "clear"] + a, this.obj[this._methods[0]](e, a), r && r.details)) {
            ...
            if (this._is_pos_changed(this._drag_pos, t)) {
                ...
                if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+v < +scheduler._min_date || +a > +scheduler._max_date)) {
                    if (+l.start_date < +scheduler._min_date || +l.end_date > +scheduler._max_date) v = new Date(l.start_date), a = new Date(l.end_date);
                        ...
                        var f = a - v; + v < +scheduler._min_date ? (v = new Date(scheduler._min_date), t._ignores && this.config.preserve_length && this._table_view ? (v = new Date(scheduler._correct_drag_start_date(v)), d._start_correction && (v = new Date(v.valueOf() + d._start_correction)), a = new Date(1 * v + this._get_fictional_event_length(v, this._drag_event._event_length, d))) : a = new Date(+v + f)) : (a = new Date(scheduler._max_date), t._ignores && this.config.preserve_length && this._table_view ? (d._end_correction && (a = new Date(a.valueOf() - d._end_correction)), a = new Date(1 * a - this._get_fictional_event_length(a, 0, d, !0)), v = new Date(1 * a - this._get_fictional_event_length(a, this._drag_event._event_length, d, !0)), this._ignores_detected && (v = scheduler.date.add(v, d.x_step, d.x_unit), a = new Date(1 * a - this._get_fictional_event_length(a, 0, d, !0)), a = scheduler.date.add(a, d.x_step, d.x_unit))) : v = new Date(+a - f))
                    }
                    var g = new Date(a - 1)
                }
        ...
        if (!e || 2 != e.button || !scheduler.config.touch) {
            if (this._drag_mode && this._drag_id) {
                ...
                if (a && (this._drag_event._dhx_changed || !this._drag_event.start_date || r.start_date.valueOf() != this._drag_event.start_date.valueOf() || r.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                    ...
                    else s ? this.deleteEvent(r.id, !0) : (this._drag_event._dhx_changed = !1, this._clear_temporary_properties(r, this._drag_event), scheduler._lame_copy(r, this._drag_event), this.updateEvent(r.id))
                }
    ...
    scheduler.render_data = function(e, t) {
        ...
        for (var r = 0; r < e.length; r++) {
            ...
            if (s._sday = this._get_event_sday(s), this._ignores[s._sday]) e.splice(r, 1), r--;
                ...
                }(l < this.config.first_hour || o >= this.config.last_hour) && (a.push(s), e[r] = s = this._copy_event(s), l < this.config.first_hour && (s.start_date.setHours(this.config.first_hour), s.start_date.setMinutes(0)), o >= this.config.last_hour && (s.end_date.setMinutes(0), s.end_date.setHours(this.config.last_hour)), s.start_date > s.end_date || l == this.config.last_hour) && (e.splice(r, 1), r--)
            }
        }
        if (!t) {
    ...
    scheduler.formSection = function(e) {
        ...
        time: {
            ...
            get_value: function(e, t, i) {
                ...
                if (t.start_date = new Date(a[r[3]].value, a[r[2]].value, a[r[1]].value, 0, a[r[0]].value), t.end_date = new Date(a[r[3] + 4].value, a[r[2] + 4].value, a[r[1] + 4].value, 0, a[r[0] + 4].value), !a[r[3]].value || !a[r[3] + 4].value) {
            ...
            if (t && i) switch (i) {
                ...
                default:
                    if (t.getAttribute("dhx_button")) scheduler.callEvent("onLightboxButton", [i, t, e]);
                        ...
                        var r, s, n; - 1 != i.indexOf("dhx_custom_button") && (-1 != i.indexOf("dhx_custom_button_") ? (r = t.parentNode.getAttribute("index"), n = t.parentNode.parentNode) : (r = t.getAttribute("index"), n = t.parentNode, t = t.firstChild)), r && (s = scheduler.form_blocks[scheduler.config.lightbox.sections[r].type], s.button_click(r, t, n, n.nextSibling))
                    }
            }
        ...
        a(document.body, e[0], function(e) {
            ...
            if (!i(e)) {
                ...
                var a;
                if (h = _ = !1, c = !0, scheduler._temp_touch_block = !0, a = l = t(e), !a) return void(_ = !0);
                var r = new Date;
            ...
            if ("string" != typeof i) {
                ...
                return this.each(function() {
                    if (this && this.getAttribute && !this.getAttribute("dhxscheduler")) {
                        ...
                        this.getElementsByTagName("div").length || (this.innerHTML = '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>', this.className += " dhx_cal_container"), scheduler.init(this, scheduler.config.date, scheduler.config.mode), i.data && scheduler.parse(i.data), a.push(scheduler)
                    }
                }), 1 === a.length ? a[0] : a
            }
