        ...
        handleWheelReal: function(a, b) {
            if (!this.wheelBusy) {
                ...
                if (f) {
                    var k = f.mouseX,
                        f = f.mouseY;
                    h != e && (k = this.rotate ? f / this.plotAreaHeight : k / this.plotAreaWidth, h *= k, e *= 1 - k);
