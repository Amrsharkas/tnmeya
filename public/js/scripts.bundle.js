...
var mUtil = function() {
    ...
    return {
        ...
        animate: function(n, o, i, l, r, s) {
            var t = {};
            if (t.linear = function(t, e, a, n) {
                    return a * t / n + e
                }, r = t.linear, "number" == typeof n && "number" == typeof o && "number" == typeof i && "function" == typeof l) {
        ...
        scrollTo: function(t, e, a) {
            ...
            l < i ? (n = i, o = l) : (n = l, o = i), e && (o += e), mUtil.animate(n, o, a, function(t) {
        ...
        scrollerInit: function(a, n) {
            function t() {
                var t, e;
                e = n.height instanceof Function ? parseInt(n.height.call()) : parseInt(n.height), n.disableForMobile && mUtil.isInResponsiveRange("tablet-and-mobile") ? (t = mUtil.data(a).get("ps")) ? (n.resetHeightOnDestroy ? mUtil.css(a, "height", "auto") : (mUtil.css(a, "overflow", "auto"), 0 < e && mUtil.css(a, "height", e + "px")), t.destroy(), t = mUtil.data(a).remove("ps")) : 0 < e && (mUtil.css(a, "overflow", "auto"), mUtil.css(a, "height", e + "px")) : (0 < e && mUtil.css(a, "height", e + "px"), mUtil.css(a, "overflow", "hidden"), (t = mUtil.data(a).get("ps")) ? t.update() : (mUtil.addClass(a, "m-scroller"), t = new PerfectScrollbar(a, {
                    wheelSpeed: .5,
                    swipeEasing: !0,
                    wheelPropagation: !1,
                    minScrollbarLength: 40,
                    suppressScrollX: !0
                }), mUtil.data(a).set("ps", t)))
            }
            t(), n.handleWindowResize && mUtil.addResizeHandler(function() {
                t()
            })
        },
...
$(document).ready(function() {
    ...
    function(g) {
        var a = "mDatatable",
            h = mUtil;
        if (void 0 === h) throw new Error("Util class is required and must be included before " + a);
        g.fn[a] = function(u) {
            if (0 !== g(this).length) {
                var p = this;
                p.debug = !1;
                var f = {
                    ...
                    init: function(t) {
                        ...
                        return null === t.data.source && (f.extractTable(), e = !0), f.setupBaseDOM.call(), f.setupDOM(p.table), f.spinnerCallback(!0), f.setDataSourceQuery(f.getOption("data.source.read.params.query")), g(p).on("m-datatable--on-layout-updated", f.afterRender), p.debug && f.stateRemove(f.stateId), g.each(f.getOption("extensions"), function(t, e) {
                            "function" == typeof g.fn[a][t] && new g.fn[a][t](p, e)
                    ...
                    fullRender: function() {
                        f.isLocked() && (g(p.tableHead).empty(), f.setHeadTitle(), f.getOption("layout.footer") && (g(p.tableFoot).empty(), f.setHeadTitle(p.tableFoot)), f.spinnerCallback(!0), g(p.wrap).removeClass("m-datatable--loaded"), f.insertData())
                    },
                    lockEnabledColumns: function() {
                        ...
                        return g.each(t, function(t, e) {
                            void 0 !== e.locked && (void 0 !== e.locked.left && h.getBreakpoint(e.locked.left) <= a && n.left.push(e.locked.left), void 0 !== e.locked.right && h.getBreakpoint(e.locked.right) <= a && n.right.push(e.locked.right))
                        }), n
                    },
                    afterRender: function(t, e) {
                        e.table == g(p.wrap).attr("id") && g(p).ready(function() {
                            f.isLocked() || (f.redraw(), f.getOption("rows.autoHide") && (f.autoHide(), g(p.table).find(".m-datatable__row").css("height", ""))), f.rowEvenOdd.call(), f.isLocked() && f.redraw(), g(p.tableBody).css("visibility", ""), g(p.wrap).addClass("m-datatable--loaded"), f.sorting.call(), f.scrollbar.call(), f.spinnerCallback(!1)
                        })
                    },
                    hoverTimer: 0,
                    isScrolling: !1,
                    ...
                    initHeight: function() {
                        if (u.layout.height && u.layout.scroll) {
                            var t = g(p.tableHead).find(".m-datatable__row").height(),
                                ...
                                a = u.layout.height;
                            0 < t && (a -= t), 0 < e && (a -= e), g(p.tableBody).css("max-height", a), g(p.tableBody).find(".m-datatable__lock--scroll").css("height", a)
                        }
                    },
                    ...
                    scrollbar: function() {
                        var n = {
                            ...
                            init: function() {
                                var t = h.getViewPort().width;
                                if (u.layout.scroll) {
                                    g(p.wrap).addClass("m-datatable--scroll");
                                    var e = g(p.tableBody).find(".m-datatable__lock--scroll");
                                    0 < g(e).find(".m-datatable__row").length && 0 < g(e).length ? (n.scrollHead = g(p.tableHead).find("> .m-datatable__lock--scroll > .m-datatable__row"), n.scrollFoot = g(p.tableFoot).find("> .m-datatable__lock--scroll > .m-datatable__row"), n.tableLocked = g(p.tableBody).find(".m-datatable__lock:not(.m-datatable__lock--scroll)"), f.getOption("layout.customScrollbar") && 10 != h.detectIE() && t > h.getBreakpoint("lg") ? n.initCustomScrollbar(e[0]) : n.initDefaultScrollbar(e)) : 0 < g(p.tableBody).find(".m-datatable__row").length && (n.scrollHead = g(p.tableHead).find("> .m-datatable__row"), n.scrollFoot = g(p.tableFoot).find("> .m-datatable__row"), f.getOption("layout.customScrollbar") && 10 != h.detectIE() && t > h.getBreakpoint("lg") ? n.initCustomScrollbar(p.tableBody) : n.initDefaultScrollbar(p.tableBody))
                                } else g(p.table).css("overflow-x", "auto")
                            },
                            initDefaultScrollbar: function(t) {
                                g(t).css("overflow", "auto").off().on("scroll", n.onScrolling)
                            },
                            ...
                            initCustomScrollbar: function(t) {
                                n.scrollable = t, f.initScrollbar(t), g(t).off().on("scroll", n.onScrolling)
                            }
                        };
                        return n.init(), n
                    },
                    initScrollbar: function(t, e) {
                        if (g(p.tableBody).css("overflow", ""), h.hasClass(t, "ps")) g(t).data("ps").update();
                        else {
                            var a = new PerfectScrollbar(t);
                            g(t).data("ps", a)
                        }
                    },
                    setHeadTitle: function(t) {
                        ...
                        void 0 === o && (o = document.createElement("tr"), t.appendChild(o)), g.each(e, function(t, e) {
                            var a = i[t];
                            if (void 0 === a && (a = document.createElement("th"), o.appendChild(a)), void 0 !== e.title && (a.innerHTML = e.title, a.setAttribute("data-field", e.field), h.addClass(a, e.class), g(a).data(e)), void 0 !== e.attr && g.each(e.attr, function(t, e) {
                                    a.setAttribute(t, e)
                                }), void 0 !== e.textAlign) {
                    ...
                    dataRender: function(t) {
                        ...
                        "local" === u.data.type || !1 === u.data.serverSorting && "sort" === t || !1 === u.data.serverFiltering && "search" === t ? e() : f.getData().done(e)
                    },
                    insertData: function() {
                        p.dataSet = p.dataSet || [];
                        ...
                        if (g.each(p.dataSet, function(t, e) {
                                ...
                                for (var n = 0; n < m; n += 1) {
                                    ...
                                    h.addClass(r, i.join(" ")), r.setAttribute("data-field", o.field), r.innerHTML = f.getObject(o.field, e), a.appendChild(r)
                                }
                                c.appendChild(a)
                            }), 0 === p.dataSet.length) {
                            var n = document.createElement("span");
                            h.addClass(n, "m-datatable--error"), n.innerHTML = f.getOption("translate.records.noRecords"), c.appendChild(n), g(p.wrap).addClass("m-datatable--error m-datatable--loaded"), f.spinnerCallback(!1)
                        }
                    ...
                    getData: function() {
                        ...
                        return g.ajax(t).done(function(t, e, a) {
                            ...
                            g(p).trigger("m-datatable--on-ajax-fail", [t]), g(p.tableBody).html(g("<span/>").addClass("m-datatable--error").html(f.getOption("translate.records.noRecords"))), g(p.wrap).addClass("m-datatable--error m-datatable--loaded"), f.spinnerCallback(!1)
                        }).always(function() {})
                    },
                    paging: function(t, e) {
                        var m = {
                            ...
                            updatePerpage: function(t) {
                                t.preventDefault(), m.pager = g(p.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"), t.originalEvent && (m.meta.perpage = parseInt(g(this).val())), g(m.pager).find("select.m-datatable__pager-size").val(m.meta.perpage).attr("data-selected", m.meta.perpage), f.setDataSourceParam("pagination", {
                                    page: m.meta.page,
                                    pages: m.meta.pages,
                                    perpage: m.meta.perpage,
                                    total: m.meta.total
                    ...
                    columnHide: function() {
                        ...
                        g.each(u.columns, function(t, e) {
                            if (void 0 !== e.responsive) {
                                ...
                                h.getBreakpoint(e.responsive.hidden) >= o ? g(n).hide() : g(n).show(), h.getBreakpoint(e.responsive.visible) <= o ? g(n).show() : g(n).hide()
                            }
                        })
                    },
                    ...
                    isLocked: function() {
                        return h.hasClass(p.wrap[0], "m-datatable--lock") || !1
                    },
                    ...
                    rowEvenOdd: function() {
                        g(p.tableBody).find(".m-datatable__row").removeClass("m-datatable__row--even"), g(p.wrap).hasClass("m-datatable--subtable") ? g(p.tableBody).find(".m-datatable__row:not(.m-datatable__row-detail):even").addClass("m-datatable__row--even") : g(p.tableBody).find(".m-datatable__row:nth-child(even)").addClass("m-datatable__row--even")
                    },
                    timer: 0,
                    redraw: function() {
                ...
                if (g.each(f, function(t, e) {
                    ...
                    if ("string" == typeof u) {
                        var t = u;
                        void 0 !== (p = g(this).data(a)) && (u = p.options, f[t].apply(this, Array.prototype.slice.call(arguments, 1)))
                    } else p.data(a) || g(this).hasClass("m-datatable--loaded") || (p.dataSet = null, p.textAlign = {
                        left: "m-datatable__cell--left",
                        center: "m-datatable__cell--center",
                        right: "m-datatable__cell--right"
                    }, u = g.extend(!0, {}, g.fn[a].defaults, u), p.options = u, f.init.apply(this, [u]), g(p.wrap).data(a, p));
                else void 0 === (p = g(this).data(a)) && g.error(a + " not initialized"), u = p.options;
                return p
            }
            console.log("No " + a + " element exist.")
        }, g.fn[a].defaults = {
            data: {
                type: "local",
                source: null,
        ...
        var a = {
            ...
            l = {
                ...
                show: function() {
                    ...
                    return n.focus(), n.setAttribute("aria-expanded", "true"), o.open = !0, mUtil.scrollersUpdate(n), l.eventTrigger("afterShow"), o
                },
...
var mHeader = function(t, e) {
    ...
    mMenu = function(t, e) {
        ...
        if (d) {
            var n = {
                ...
                f = {
                    ...
                    scrollerInit: function() {
                        p.options.scroll && p.options.scroll.height && (mUtil.scrollerDestroy(d), mUtil.scrollerInit(d, {
                            disableForMobile: !0,
                            resetHeightOnDestroy: !0,
                            handleWindowResize: !0,
                            height: p.options.scroll.height
                        }))
                    },
                    scrollerUpdate: function() {
                        p.options.scroll && p.options.scroll.height ? mUtil.scrollerUpdate(d) : mUtil.scrollerDestroy(d)
                    },
                    scrollerTop: function() {
                        p.options.scroll && p.options.scroll.height && mUtil.scrollerTop(d)
                    },
                    ...
                    handleLinkClick: function(t) {
                        !1 === f.eventTrigger("linkClick", this) && t.preventDefault(), ("dropdown" === f.getSubmenuMode(this) || f.isConditionalSubmenuDropdown()) && f.handleSubmenuDropdownClose(t, this)
                    },
                    handleSubmenuDrodownHoverEnter: function(t) {
                        if ("accordion" !== f.getSubmenuMode(this) && !1 !== p.resumeDropdownHover()) {
                            var e = this;
                    ...
                    handleSubmenuDrodownHoverExit: function(t) {
                        if (!1 !== p.resumeDropdownHover() && "accordion" !== f.getSubmenuMode(this)) {
                            var e = this,
                    ...
                    handleSubmenuDropdownClick: function(t) {
                        if ("accordion" !== f.getSubmenuMode(this)) {
                    ...
                    handleSubmenuDropdownClose: function(t, e) {
                        if ("accordion" !== f.getSubmenuMode(e)) {
                    ...
                    handleSubmenuAccordion: function(t, e) {
                        var a, n = e || this;
                        if ("dropdown" === f.getSubmenuMode(e) && (a = n.closest(".m-menu__item")) && "accordion" != a.getAttribute("m-menu-submenu-mode")) t.preventDefault();
                        else {
                                        ...
                                        if (r && s)
                                            for (var d = 0, c = s.length; d < c; d++) {
                                                ...
                                                u && mUtil.slideUp(u, l, function() {
                                                    f.scrollerUpdate(), mUtil.removeClass(m, "m-menu__item--open")
                                                })
                                            }
                                    }
                                    mUtil.slideDown(i, l, function() {
                                        f.scrollToItem(n), f.scrollerUpdate(), f.eventTrigger("submenuToggle", i)
                                    }), mUtil.addClass(o, "m-menu__item--open")
                                } else mUtil.slideUp(i, l, function() {
                                    f.scrollToItem(n), f.eventTrigger("submenuToggle", i)
                                }), mUtil.removeClass(o, "m-menu__item--open")
                            }
                        }
                    },
                    scrollToItem: function(t) {
                        mUtil.isInResponsiveRange("desktop") && p.options.accordion.autoScroll && "1" !== d.getAttribute("m-menu-scrollable") && mUtil.scrollTo(t, p.options.accordion.autoScrollSpeed)
                    },
                    ...
                    removeEvent: function(t) {
                        p.events[t] && delete p.events[t]
                    }
                };
            return p.setDefaults = function(t) {
                n = t
            }, p.scrollerUpdate = function() {
                return f.scrollerUpdate()
            }, p.scrollerTop = function() {
                return f.scrollerTop()
            ...
            }, p.getSubmenuMode = function(t) {
                return f.getSubmenuMode(t)
        ...
        if (a) {
            var i = {
                ...
                l = {
                    ...
                    scroll: function(t) {
                        t.preventDefault(), mUtil.scrollTop(0, o.options.speed)
                    },
                    eventTrigger: function(t, e) {
                        for (var a = 0; a < o.events.length; a++) {
                            var n = o.events[a];
        ...
        if (a) {
            var o = {
                ...
                l = {
                    ...
                    toggle: function() {
                        return l.eventTrigger("beforeToggle"), "off" == n.state ? l.toggleOn() : l.toggleOff(), n
                    },
                    toggleOn: function() {
        ...
        if (o) {
            var a = {
                ...
                r = {
                    ...
                    init: function(t) {
                        l.element = o, l.events = [], l.options = mUtil.deepExtend({}, a, t), l.steps = mUtil.findAll(o, ".m-wizard__step"), l.progress = mUtil.find(o, ".m-wizard__progress .progress-bar"), l.btnSubmit = mUtil.find(o, '[data-wizard-action="submit"]'), l.btnNext = mUtil.find(o, '[data-wizard-action="next"]'), l.btnPrev = mUtil.find(o, '[data-wizard-action="prev"]'), l.btnLast = mUtil.find(o, '[data-wizard-action="last"]'), l.btnFirst = mUtil.find(o, '[data-wizard-action="first"]'), l.events = [], l.currentStep = 1, l.stopped = !1, l.totalSteps = l.steps.length, 1 < l.options.startStep && r.goTo(l.options.startStep), r.updateUI()
                    },
                    build: function() {
                    ...
                    goTo: function(t) {
                        if (!(t === l.currentStep || t > l.totalSteps || t < 0)) {
                            var e;
                            if (e = (t = t ? parseInt(t) : r.getNextStep()) > l.currentStep ? r.eventTrigger("beforeNext") : r.eventTrigger("beforePrev"), !0 !== l.stopped) return !1 !== e && (r.eventTrigger("beforeChange"), l.currentStep = t, r.updateUI(), r.eventTrigger("change")), t > l.startStep ? r.eventTrigger("afterNext") : r.eventTrigger("afterPrev"), l;
                            l.stopped = !1
                        }
                    },
...
! function(l) {
    ...
    l.fn[t] = l.fn[t] || {}, l.fn[t].checkbox = function(n, o) {
        var i = {
            ...
            unselectedRows: [],
            init: function() {
                n.stateRemove("checkbox"), i.selectorEnabled() && (o.vars.requestIds && n.setDataSourceParam(o.vars.requestIds, !0), i.selectedAllRows = n.getDataSourceParam(o.vars.selectedAllRows), l(n).on("m-datatable--on-layout-updated", function(t, e) {
                    e.table == l(n.wrap).attr("id") && n.ready(function() {
                        i.initVars(), i.initEvent(), i.initSelect()
                    })
                }), l(n).on("m-datatable--on-check", function(t, e) {
                ...
                }), l(n).on("m-datatable--on-uncheck", function(t, e) {
                    e.forEach(function(t) {
...
var mLayout = function() {
    var s, d, c, n, m, u, p = function() {
            0 !== $("#m_aside_left_hide_toggle").length && (p = new mToggle("m_aside_left_hide_toggle", {
                target: "body",
                targetState: "m-aside-left--hide",
                togglerState: "m-brand__toggler--active"
            })).on("toggle", function(t) {
                s.pauseDropdownHover(800), d.pauseDropdownHover(800), Cookies.set("sidebar_hide_state", t.getState())
            })
        },
        t = function() {
    ...
    return {
        ...
        initMainPortlet: function() {
            mUtil.get("main_portlet") && ((u = t()).initSticky(), mUtil.addResizeHandler(function() {
                u.updateSticky()
            }))
        },
        resetMainPortlet: function() {
            u.destroySticky(), (u = t()).initSticky()
        },
        initHeader: function() {
            var t, e, a;
        ...
        initAside: function() {
            var t, e, a, n, o, i, l, r;
            a = mUtil.get("body"), n = mUtil.get("m_aside_left"), o = mUtil.hasClass(n, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", c = new mOffcanvas("m_aside_left", {
                baseClass: o,
                overlay: !0,
            ...
            }), mUtil.hasClass(a, "m-aside-left--fixed") && (mUtil.addEvent(n, "mouseenter", function() {
                e && (clearTimeout(e), e = null), t = setTimeout(function() {
                    mUtil.hasClass(a, "m-aside-left--minimize") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(a, "m-aside-left--minimize"), mUtil.addClass(a, "m-aside-left--minimize-hover"), d.scrollerUpdate(), d.scrollerTop())
                }, 300)
            }), mUtil.addEvent(n, "mouseleave", function() {
                t && (clearTimeout(t), t = null), e = setTimeout(function() {
                    mUtil.hasClass(a, "m-aside-left--minimize-hover") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(a, "m-aside-left--minimize-hover"), mUtil.addClass(a, "m-aside-left--minimize"), d.scrollerUpdate(), d.scrollerTop())
                }, 500)
            })), l = mUtil.get("m_ver_menu"), r = "1" === mUtil.attr(l, "m-menu-dropdown") ? "dropdown" : "accordion", "1" === mUtil.attr(l, "m-menu-scrollable") && (i = {
                height: function() {
                    if (mUtil.isInResponsiveRange("desktop")) return mUtil.getViewPort().height - parseInt(mUtil.css("m_header", "height"))
                }
            }), d = new mMenu("m_ver_menu", {
                scroll: i,
                submenu: {
                    desktop: {
                        default: r,
            ...
            }), 0 !== $("#m_aside_left_minimize_toggle").length && ((m = new mToggle("m_aside_left_minimize_toggle", {
                target: "body",
                targetState: "m-brand--minimize m-aside-left--minimize",
                togglerState: "m-brand__toggler--active"
            })).on("toggle", function(t) {
                mUtil.get("main_portlet") && u.updateSticky(), s.pauseDropdownHover(800), d.pauseDropdownHover(800), Cookies.set("sidebar_toggle_state", t.getState())
            }), m.on("beforeToggle", function(t) {
            ...
            })), p(), this.onLeftSidebarToggle(function(t) {
                u && u.updateSticky();
                var e = $(".m-datatable");
                e && e.each(function() {
...
var mQuickSidebar = function() {
    var o = $("#m_quick_sidebar"),
        i = $("#m_quick_sidebar_tabs"),
        t = o.find(".m-quick-sidebar__content"),
        e = function() {
            var t, e, a, n;
            t = mUtil.find(mUtil.get("m_quick_sidebar_tabs_messenger"), ".m-messenger__messages"), e = $("#m_quick_sidebar_tabs_messenger .m-messenger__form"), mUtil.scrollerInit(t, {
                disableForMobile: !0,
                resetHeightOnDestroy: !1,
                handleWindowResize: !0,
                height: function() {
                    return o.outerHeight(!0) - i.outerHeight(!0) - e.outerHeight(!0) - 120
                }
            }), (a = mUtil.find(mUtil.get("m_quick_sidebar_tabs_settings"), ".m-list-settings")) && mUtil.scrollerInit(a, {
                disableForMobile: !0,
                resetHeightOnDestroy: !1,
                handleWindowResize: !0,
                height: function() {
                    return mUtil.getViewPort().height - i.outerHeight(!0) - 60
                }
            }), (n = mUtil.find(mUtil.get("m_quick_sidebar_tabs_logs"), ".m-list-timeline")) && mUtil.scrollerInit(n, {
                disableForMobile: !0,
                resetHeightOnDestroy: !1,
                handleWindowResize: !0,
                height: function() {
    ...
    return {
        init: function() {
            0 !== o.length && new mOffcanvas("m_quick_sidebar", {
                overlay: !0,
                baseClass: "m-quick-sidebar",
                closeBy: "m_quick_sidebar_close",
                toggleBy: "m_quick_sidebar_toggle"
            }).one("afterShow", function() {
                mApp.block(o), setTimeout(function() {
                    mApp.unblock(o), t.removeClass("m--hide"), e()
                }, 1e3)
            })
        }
    }
