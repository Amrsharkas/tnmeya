    ...
    <div class="m-portlet__head qu-portlet__head">
        ...
        <div class="m-portlet__head-wrapper">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{url()->previous()}}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10 go-back">
                    <span>
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-brand  m-btn m-btn--icon m-btn--wide m-btn--md  virtual-save">
                        <span>
